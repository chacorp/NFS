...
def main(basedir = '/data/ICT-audio2face/raw',
    ...
    file_paths = glob.glob(os.path.join(basedir,"*","*",'out.wav'))
    # file_paths = glob.glob(os.path.join(basedir,"m01","*",'out.wav'))
    import natsort
    ...
    for idx, file_path in enumerate(file_paths):
        ...
        save_fn = f'{save_dir}/{person_id}/wav/{audio_id}.wav'
        save_dir_ = f'{save_dir}/{person_id}/wav/'
